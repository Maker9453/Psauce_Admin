...
def embeds(thing):  # 什麼的嵌入
    if thing == "alltheinfo":
        embed = discord.Embed(title="全部資訊( >ps_info 資料集 )", color=0x36b7b5,
    ...
    if thing == "bot_info":
        embed = discord.Embed(title="< Ps_Admin - 資訊集 >", color=0x36b7b5,
                              timestamp=datetime.datetime.now(datetime.timezone.utc))
    ...
    if thing == "author_info":
        embed = discord.Embed(title="< Author - 資訊集 >", color=0x36b7b5,
                              timestamp=datetime.datetime.now(datetime.timezone.utc))
    ...
    if thing == "dcguild_info":
        embed = discord.Embed(title="< Dc_Guild - 資訊集 >", color=0x36b7b5,
                              timestamp=datetime.datetime.now(datetime.timezone.utc))
